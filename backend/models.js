...
const Gallery = mongoose.model('Gallery', new mongoose.Schema({ title: { type: String, required: true, trim: true }, caption: { type: String, default: '', trim: true }, filename: String, originalName: String, path: String, mediaType: String, mediaData: Buffer, displayOrder: { type: Number, default: 0 } }, opts));
